...
class LoginViewController: UIViewController {
    ...
    private let usernameEmailField: UITextField = {
        ...
        field.placeholder = "Username or field..."
    ...
    override func viewDidLayoutSubviews() {
        ...
        termsButton.frame = CGRect(x: 25, y: view.height-view.safeAreaInsets.bottom-100, width: view.width-20, height: 50)
        
        privacyButton.frame = CGRect(x: 25, y: view.height-view.safeAreaInsets.bottom-50, width: view.width-20, height: 50)
